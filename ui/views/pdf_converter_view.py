...
from ui.components.neon_widgets import NeonSelectionDelegate, NeonProxyStyle, CustomComboBox, CustomSpinBox, CustomCheckBox, CustomPushButton
...
class ExportConfigPanel(QtWidgets.QScrollArea):
    ...
    def setup_ui(self):
        ...
        self.th_size_side_combobox.addItems(["Lado corto", "Lado largo", "Cuadrado"])
        ...
        self.th_save_route.addItems(["Misma que el PDF", "En carpeta raíz"])
...
class PDFConverterView(QtWidgets.QWidget):
    ...
    def build_individual_tab(self, parent_widget):
        ...
        self.list_sandbox.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DragDrop)
    ...
    def _save_and_continue(self):
        """Captura y guarda las configuraciones al darle al botón CONVERTIR."""
        # Si el usuario está en la pestaña de Lote (index 0), guardamos esos valores. 
        # Si está en Individual, guardamos los de Individual.
        if self.tab_widget.currentIndex() == 0:
            self.batch_config.save_settings(config_manager)
        else:
